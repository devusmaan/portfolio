...
export default function Navbar() {
    ...
    return (
        <>
            ...
            < div
                className={`fixed w-full pt-16 h-screen z-40 flex flex-col items-start justify-center transform transition-transform duration-1000 ${menuOpen ? "translate-y-0" : "-translate-y-full"
                    } md:translate-y-0 md:relative md:h-auto ml-6 md:w-1/6`
                }
            >
                <nav className="flex flex-col items-center md:fixed md:p-5">
